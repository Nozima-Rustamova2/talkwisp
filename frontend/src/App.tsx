  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--ground)" }}>
      ...
      >
        ...
        {/* No business name, no user, no language pills, no nav rail. Every one
            of those is a real thing in the prototype and has no backend: there
            is no business record, no account, no i18n and no other screen. A
            rail of six links to nothing is exactly the dishonesty the design
            docs argue against, so it is absent rather than inert. */}
      </header>
